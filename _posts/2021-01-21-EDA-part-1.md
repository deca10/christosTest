...
![unnamed-chunk-8-1](EDA_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
![unnamed-chunk-9-1](EDA_files/figure-markdown_github/unnamed-chunk-9-1.png)

Now it is easy to observe the differences in the distribution of
*pelvic_tilt* across the different levels of *class*. In almost the same
way the density function can be displayed
...
![unnamed-chunk-10-1](EDA_files/figure-markdown_github/unnamed-chunk-10-1.png)
...
![unnamed-chunk-11-1](EDA_files/figure-markdown_github/unnamed-chunk-11-1.png)

The code below explores *pelvic_tilt* in all three levels of the *class*
variable.
...
![unnamed-chunk-12-1](EDA_files/figure-markdown_github/unnamed-chunk-12-1.png) We can see
the deviation from the 45 degree line for the *SL* level of *class*. We
previously observed that when we tested for normality with the
shapiro.wilk test.
...
![unnamed-chunk-13-1](EDA_files/figure-markdown_github/unnamed-chunk-13-1.png) It seems
that there is some kind of linear relationship between the variables and
also an extreme value that is probably an outlier. We can go a step
further just by adding some color at the points.
...
![unnamed-chunk-14-1](EDA_files/figure-markdown_github/unnamed-chunk-14-1.png)
